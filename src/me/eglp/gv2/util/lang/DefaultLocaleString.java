...
<<<<<<< HEAD
	...
	COMMAND_REMINDER_MESSAGE_ENUM("command.reminder.message.enum", "{enum} Reminder:"),
	COMMAND_REMINDER_MESSAGE_SIMPLE("command.reminder.message.simple", "Unique Reminder:"),
